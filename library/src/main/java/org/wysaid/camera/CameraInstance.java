...
public class CameraInstance {
    ...
    private static final int DEFAULT_PICTURE_SIZE = 1024;
    ...
    private int mPictureWidth = DEFAULT_PICTURE_SIZE;
    private int mPictureHeight = DEFAULT_PICTURE_SIZE;
...
//                mCameraDevice.setPreviewCallbackWithBuffer(callback);
    ...
    public void initCamera(int previewRate) {
        ...
        mParams.setJpegQuality(mJpegQuality);
...
//        mParams.setPreviewFpsRange(20, 60);
    ...
    public synchronized void setPictureSize(int width, int height, boolean isBigger) {
        if (width < DEFAULT_PICTURE_SIZE || height < DEFAULT_PICTURE_SIZE) {
